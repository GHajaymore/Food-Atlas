...
export const CATALOGUES: Readonly<Record<string, Partial<Copy> & Partial<PluralExtras>>> = {
  es: {
    ...
    screenFailed: "Esta pantalla se ha detenido",
    screenFailedBody: "Algo ha fallado aquí, y solo aquí: el resto del atlas está bien. Vuelve a intentarlo o regresa al inicio.",
  ...
  fr: {
    ...
    screenFailed: "Cet écran s’est arrêté",
    screenFailedBody: "Quelque chose n’a pas fonctionné ici, et seulement ici — le reste de l’atlas va bien. Réessayez cet écran, ou revenez à l’accueil.",
    tryAgain: "Réessayer cet écran",
  ...
  de: {
    ...
    screenFailed: "Diese Seite ist stehengeblieben",
    screenFailedBody: "Hier ist etwas schiefgegangen, und nur hier — der übrige Atlas ist in Ordnung. Versuchen Sie es noch einmal, oder gehen Sie zurück.",
  ...
  it: {
    ...
    screenFailed: "Questa schermata si è fermata",
    screenFailedBody: "Qualcosa è andato storto qui, e solo qui: il resto dell’atlante sta bene. Riprova, oppure torna all’inizio.",
    tryAgain: "Riprova",
  ...
  pt: {
    ...
    screenFailed: "Este ecrã parou",
    screenFailedBody: "Algo correu mal aqui, e apenas aqui — o resto do atlas está bem. Tente de novo, ou volte ao início.",
  ...
  nl: {
    ...
    screenFailed: "Dit scherm is gestopt",
    screenFailedBody: "Hier ging iets mis, en alleen hier — de rest van de atlas is in orde. Probeer het opnieuw, of ga terug.",
  ...
  pl: {
    ...
    screenFailed: "Ten ekran się zatrzymał",
    screenFailedBody: "Coś tu poszło nie tak, i tylko tutaj — reszta atlasu działa. Spróbuj ponownie albo wróć na początek.",
  ...
  tr: {
    ...
    screenFailed: "Bu ekran durdu",
    screenFailedBody: "Burada bir şeyler ters gitti, yalnızca burada — atlasın geri kalanı iyi. Yeniden deneyin ya da başa dönün.",
  ...
  ru: {
    ...
    screenFailed: "Этот экран остановился",
    screenFailedBody: "Здесь что-то пошло не так, и только здесь — остальной атлас в порядке. Попробуйте снова или вернитесь на главную.",
  ...
  hi: {
    ...
    screenFailed: "यह स्क्रीन रुक गई",
    screenFailedBody: "यहाँ कुछ गड़बड़ हुई, और सिर्फ़ यहीं — बाकी एटलस ठीक है। दोबारा कोशिश करें, या शुरुआत पर लौटें।",
  ...
  zh: {
    ...
    loadingAtlas: '正在读取图谱…',
    screenFailed: "此页面出错了",
    screenFailedBody: "这里出了问题，仅限此处——图册的其余部分一切正常。请重试，或返回首页。",
    tryAgain: "重试此页面",
    couldNotLoad: '无法加载图谱。',
  ...
  ja: {
    ...
    screenFailed: "この画面は停止しました",
    screenFailedBody: "ここだけで問題が起きました。アトラスの他の部分は正常です。もう一度お試しになるか、最初の画面へお戻りください。",
    tryAgain: "もう一度試す",
